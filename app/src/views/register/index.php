...
<head>
    ...
    <title>IT Creator | Register</title>
</head>

<body>
    <?php include dirname(__DIR__, 1) . '/partials/header.php' ?>
    <main class="app-main register-main">
        <section aria-labelledby="register-title" class="register-main__central-section">
            <h1 id="register-title"><?php echo $title ?></h1>
            <form action="./?url=register/authenticate" method="POST" class="custom-form">
                <section class="register-form__fields-section">
                    <?php foreach ($form_fields as $field): ?>
                        <article class="custom-field">
                            <section class="control has-icons-left">
                                <section class="register-form-field__label-input-section">
                ...
                <section class="register-form__buttons-section">
